...
//							porta2 = true;
//							System.out.println("porta 2 ligada");
//							S_Interruptor.alterarEstado("601 A");
//						} else if (linha.equals("porta2Des")) {
//							porta2 = false;
//							System.out.println("porta 2 desligada");
//							S_Interruptor.alterarEstado("601 A");
//						} else if (linha.equals("porta3Lig")) {
//							porta3 = true;
//							System.out.println("porta 3 ligada");
//							S_Interruptor.alterarEstado("601 B");
//						} else if (linha.equals("porta3Des")) {
//							porta3 = false;
//							System.out.println("porta 3 desligada");
//							S_Interruptor.alterarEstado("601 B");
//
//						} else if (linha.equals("porta4Lig")) {
//							porta4 = true;
//							System.out.println("porta 4 ligada");
//							S_Interruptor.alterarEstado("601 C");
//
//						} else if (linha.equals("porta4Des")) {
//							porta4 = false;
//							System.out.println("porta 4 desligada");
//							S_Interruptor.alterarEstado("601 C");
//
//						} else if (linha.equals("porta5Lig")) {
//							porta5 = true;
//							System.out.println("porta 5 ligada");
//							S_Interruptor.alterarEstado("601 D");
//
//						} else if (linha.equals("porta5Des")) {
//							porta5 = false;
//							System.out.println("porta 5 desligada");
//							S_Interruptor.alterarEstado("601 D");
//
//						} else if (linha.equals("porta6Lig")) {
//							porta6 = true;
//							System.out.println("porta 6 ligada");
//							S_Interruptor.alterarEstado("Emergência 601");
//
//						} else if (linha.equals("porta6Des")) {
//							porta6 = false;
//							System.out.println("porta 6 desligada");
//							S_Interruptor.alterarEstado("Emergência 601");
//
//						}
//					}
